...
int main(int argc, char *argv[]) {
    ...
    auto *problemData1 = new ProblemData();
    Utility::generateProblem((seed + 1 * JUMP_SIZE) & INT_LIM, *problemData1);

    auto *problemData2 = new ProblemData();
    Utility::generateProblem((seed + 2 * JUMP_SIZE) & INT_LIM, *problemData2);

    auto *problemData3 = new ProblemData();
    Utility::generateProblem((seed + 3 * JUMP_SIZE) & INT_LIM, *problemData3);
